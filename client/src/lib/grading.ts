...
export function getGradeBadgeColor(grade: string): string {
  if (grade.startsWith('A')) return 'text-green-600 dark:text-green-400 bg-green-100 dark:bg-green-900/30 border-green-500/30';
  if (grade.startsWith('B')) return 'text-blue-600 dark:text-blue-400 bg-blue-100 dark:bg-blue-900/30 border-blue-500/30';
  if (grade.startsWith('C')) return 'text-yellow-600 dark:text-yellow-400 bg-yellow-100 dark:bg-yellow-900/30 border-yellow-500/30';
  if (grade.startsWith('D')) return 'text-orange-600 dark:text-orange-400 bg-orange-100 dark:bg-orange-900/30 border-orange-500/30';
  return 'text-red-600 dark:text-red-400 bg-red-100 dark:bg-red-900/30 border-red-500/30';
}
